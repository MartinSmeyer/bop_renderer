...
osmesaprefix="${OSMESA_PREFIX:-/home_local/sund_ma/src/foreign_packages/bop/required_pkgs/osmesa}"
# mesa version
...
llvmprefix="${LLVM_PREFIX:-/home_local/sund_ma/src/foreign_packages/bop/required_pkgs/llvm}"
